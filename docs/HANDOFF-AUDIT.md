...
| C | 無停損版 v3 為對照 | 現代 +17,438/MDD −3,012；歷史 +53,496/18/18（analysis16 口徑。注：analysis19 的無停損基準列為 +17,492——兩腳本的有效日納入條件略異，差 0.3%，屬已知且揭露的實作差） | `python3 scripts/analysis16_playbook3.py`（應印出「正年=18/18」「正年=4/4」） | `output/v14_longcheck_trades.csv`、`v15_v3b_modern.csv` |
